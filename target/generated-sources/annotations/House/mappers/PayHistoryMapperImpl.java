...
public class PayHistoryMapperImpl implements PayHistoryMapper {
    ...
    public PayHistory toPayHistory(PayHistoryDto payHistoryDto) {
        ...
        payHistory.setReserveHistory( reserveHistoryDtoToReserveHistory( payHistoryDto.getReserveHistory() ) );
        payHistory.setCash( payHistoryDto.getCash() );
        payHistory.setAddDate( payHistoryDto.getAddDate() );
    ...
    public PayHistoryDto toPayHistoryDto(PayHistory payHistory) {
        ...
        payHistoryDto.setReserveHistory( reserveHistoryToReserveHistoryDto( payHistory.getReserveHistory() ) );
        payHistoryDto.setCash( payHistory.getCash() );
        payHistoryDto.setAddDate( payHistory.getAddDate() );

        return payHistoryDto;
    }

    @Override
    public List<PayHistory> toPayHistoryList(List<PayHistoryDto> payHistoryDtoList) {
        if ( payHistoryDtoList == null ) {
            return null;
        }

        List<PayHistory> list = new ArrayList<PayHistory>( payHistoryDtoList.size() );
        for ( PayHistoryDto payHistoryDto : payHistoryDtoList ) {
            list.add( toPayHistory( payHistoryDto ) );
        }
    ...
    @Override
    public List<PayHistoryDto> toPayHistoryDtoList(List<PayHistory> payHistories) {
        if ( payHistories == null ) {
            return null;
        }

        List<PayHistoryDto> list = new ArrayList<PayHistoryDto>( payHistories.size() );
        for ( PayHistory payHistory : payHistories ) {
            list.add( toPayHistoryDto( payHistory ) );
        }
    ...
    protected ReserveHistory reserveHistoryDtoToReserveHistory(ReserveHistoryDto reserveHistoryDto) {
    ...
    protected ReserveHistoryDto reserveHistoryToReserveHistoryDto(ReserveHistory reserveHistory) {
